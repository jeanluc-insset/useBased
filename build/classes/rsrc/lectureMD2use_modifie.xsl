...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
 xmlns:uml2_2='http://schema.omg.org/spec/UML/2.2'
 ...
 xmlns:stéréotypes='http://www.magicdraw.com/schemas/stéréotypes.xmi'>
    ...
    <xsl:key name="scenarios" match="ownedBehavior[@xmi:type='uml2_2:Interaction']" use="1"/>
    ...
    <xsl:key name="classes" match="packagedElement[@xmi:type='uml2_2:Class']" use="@xmi:id"/>
    ...
    <xsl:template match="/" mode="use">
        ...
        <xsl:value-of select="xmi:XMI/uml2_2:Model/@name"/>

        <xsl:apply-templates
            select="//packagedElement[@xmi:type='uml2_2:Class']" mode="use"/>

        <xsl:apply-templates
            select="//packagedElement[@xmi:type='uml2_2:Association']" mode="use"/>

constraints

        <xsl:apply-templates
                select="//packagedElement[@xmi:type='uml2_2:Class']/ownedRule" mode="use"/>
    ...
    <xsl:template match="packagedElement[@xmi:type='uml2_2:Class']" mode="use">
...
<xsl:text>    
    ...
    <xsl:template match="packagedElement[@xmi:type='uml2_2:Class']" mode="constraints">
...
context </xsl:text>
    ...
    <xsl:template match="packagedElement[@xmi:type='uml2_2:Association']" mode="use">
...
association </xsl:text>
    <xsl:choose>
        ...
        <xsl:otherwise>
            ...
            <xsl:value-of select="count(preceding::packagedElement[@xmi:type='uml2_2:Association'])+1"/>
        </xsl:otherwise>
    </xsl:choose>
    <xsl:text> between
    </xsl:text>
...
<!--        <xsl:text> role </xsl:text>
    ...
    <xsl:template match="packagedElement[@xmi:type='uml2_2:Actor']">
    ...
    <xsl:template match="packagedElement[@xmi:type='uml2_2:Class']">
            <name><xsl:value-of select="@name"/></name>
...
<!--                    <xsl:value-of select="substring-after(@type, '#')"/>-->
    ...
    <xsl:template match="packagedElement[@xmi:type='uml2_2:Class']" mode="ui">
    ...
    <!--
      ...
      -->
    <xsl:template match="ownedBehavior[@xmi:type='uml2_2:Interaction']">
...
<!--                        <xsl:text>java.util.Date</xsl:text>-->
    ...
    <xsl:template match="packagedElement[@xmi:type='uml2_2:Package']" mode="calcPackage">
        <xsl:if test="parent::packagedElement[@xmi:type='uml2_2:Package']">
