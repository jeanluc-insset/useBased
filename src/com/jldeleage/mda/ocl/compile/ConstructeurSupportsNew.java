 ...
 * @author jldeleage
 */
public class ConstructeurSupportsNew {
    ...
    public void construisSupports(Classe inClasse) {
        ...
        for (Invariant unInvariant : inClasse.getInvariants()) {
            MClassInvariant invariantUse = unInvariant.getInvariantUse();
            Expression bodyExpression = invariantUse.bodyExpression();
            bodyExpression.processWithVisitor(new VisiteurConstructeurSupport(unInvariant));
        }
    }   // construisSupports
    ...
    private class VisiteurConstructeurSupport extends AbstractVisitor {

        public VisiteurConstructeurSupport(Invariant inInvariant) {
            monInvariant = inInvariant;
        }
        ...
        public void visitNavigation(ExpNavigation exp) {
            ...
            if (fromSelf) {
                ...
                monInvariant.addRole(role);
                role.addInvariant(monInvariant);
...
//                Predicat predicat = constructeurPredicats.construisPredicat(monInvariant, role);
//                role.addPredicat(predicat);
                ...
                monInvariant.addRoleElargi(role);
                role.addAutreInvariant(monInvariant);
            }
        }       // visitNavigation
...
//                System.out.println("Attention : variable non traitee : " + exp);
         ...
         * Toute autre navigation ou op&eacute;ration positionne &agrave;
         * false.<br/>
         * TODO : regarder des invariants du genre
         * self &lt;&gt; Pilote.allInstances->select(p | ... )
         */
        private boolean   fromSelf;
        private Invariant monInvariant;
