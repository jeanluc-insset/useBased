// $ANTLR 3.3 Nov 30, 2010 12:45:30 ShellCommand.g 2011-10-20 16:14:27
...
@SuppressWarnings("all") public class ShellCommandLexer extends Lexer {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1605:3: ( ( ' ' | '\\t' | '\\f' | NEWLINE ) )
            // ShellCommand.g:1606:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            {
            // ShellCommand.g:1606:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1622:11: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // ShellCommand.g:1623:5: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); if (state.failed) return ;

            // ShellCommand.g:1623:10: ( options {greedy=false; } : . )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mARROW() throws RecognitionException {
        try {
            int _type = ARROW;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1630:10: ( '->' )
            // ShellCommand.g:1630:12: '->'
            {
            match("->"); if (state.failed) return ;
    ...
    public final void mBAR() throws RecognitionException {
        try {
            int _type = BAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1632:8: ( '|' )
            // ShellCommand.g:1632:10: '|'
            {
            match('|'); if (state.failed) return ;
    ...
    public final void mCOLON_COLON() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1634:14: ( '::' )
            // ShellCommand.g:1634:16: '::'
            {
            match("::"); if (state.failed) return ;
    ...
    public final void mGREATER() throws RecognitionException {
        try {
            int _type = GREATER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1640:11: ( '>' )
            // ShellCommand.g:1640:13: '>'
            {
            match('>'); if (state.failed) return ;
    ...
    public final void mGREATER_EQUAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1641:15: ( '>=' )
            // ShellCommand.g:1641:17: '>='
            {
            match(">="); if (state.failed) return ;
    ...
    public final void mLESS_EQUAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1646:14: ( '<=' )
            // ShellCommand.g:1646:16: '<='
            {
            match("<="); if (state.failed) return ;
    ...
    public final void mLPAREN() throws RecognitionException {
        try {
            int _type = LPAREN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1647:11: ( '(' )
            // ShellCommand.g:1647:13: '('
            {
            match('('); if (state.failed) return ;
    ...
    public final void mMINUS() throws RecognitionException {
        try {
            int _type = MINUS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1648:10: ( '-' )
            // ShellCommand.g:1648:12: '-'
            {
            match('-'); if (state.failed) return ;
    ...
    public final void mNOT_EQUAL() throws RecognitionException {
        try {
            int _type = NOT_EQUAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1649:13: ( '<>' )
            // ShellCommand.g:1649:15: '<>'
            {
            match("<>"); if (state.failed) return ;
    ...
    public final void mPLUS() throws RecognitionException {
        try {
            int _type = PLUS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1650:9: ( '+' )
            // ShellCommand.g:1650:11: '+'
            {
            match('+'); if (state.failed) return ;
    ...
    public final void mSTAR() throws RecognitionException {
        try {
            int _type = STAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1656:9: ( '*' )
            // ShellCommand.g:1656:11: '*'
            {
            match('*'); if (state.failed) return ;
    ...
    public final void mINT() throws RecognitionException {
        try {
            // ShellCommand.g:1659:4: ( ( '0' .. '9' )+ )
            // ShellCommand.g:1660:5: ( '0' .. '9' )+
            {
            // ShellCommand.g:1660:5: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
    ...
    public final void mREAL() throws RecognitionException {
        try {
            // ShellCommand.g:1664:5: ( INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT ) )
            // ShellCommand.g:1665:5: INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            {
            mINT(); if (state.failed) return ;
            // ShellCommand.g:1665:9: ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // ShellCommand.g:1665:10: '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    {
                    match('.'); if (state.failed) return ;
                    mINT(); if (state.failed) return ;
                    // ShellCommand.g:1665:18: ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    int alt8=2;
                    ...
                    switch (alt8) {
                        case 1 :
                            // ShellCommand.g:1665:19: ( 'e' | 'E' ) ( '+' | '-' )? INT
                            {
                    ...
                    break;
                case 2 :
                    // ShellCommand.g:1665:52: ( 'e' | 'E' ) ( '+' | '-' )? INT
                    {
                    if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                        input.consume();
                    state.failed=false;
    ...
    public final void mRANGE_OR_INT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1668:13: ( ( INT '..' )=> INT | ( REAL )=> REAL | INT )
            int alt11=3;
            ...
            switch (alt11) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // ShellCommand.g:1670:7: ( REAL )=> REAL
                    {
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            int _type = STRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1675:7: ( '\\'' (~ ( '\\'' | '\\\\' ) | ESC )* '\\'' )
            // ShellCommand.g:1676:5: '\\'' (~ ( '\\'' | '\\\\' ) | ESC )* '\\''
            {
            match('\''); if (state.failed) return ;
            // ShellCommand.g:1676:10: (~ ( '\\'' | '\\\\' ) | ESC )*
            loop12:
            do {
                int alt12=3;
    ...
    public final void mNON_OCL_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1678:15: ( '\"' (~ ( '\"' | '\\\\' ) | ESC )* '\"' )
            // ShellCommand.g:1679:5: '\"' (~ ( '\"' | '\\\\' ) | ESC )* '\"'
            {
            match('\"'); if (state.failed) return ;
            // ShellCommand.g:1679:9: (~ ( '\"' | '\\\\' ) | ESC )*
            loop13:
            do {
                int alt13=3;
    ...
    public final void mESC() throws RecognitionException {
        try {
            // ShellCommand.g:1691:1: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? ) )
            // ShellCommand.g:1692:5: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            {
            match('\\'); if (state.failed) return ;
            // ShellCommand.g:1693:6: ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            int alt17=11;
            switch ( input.LA(1) ) {
            case 'n':
                {
            ...
            switch (alt17) {
                ...
                case 8 :
                    ...
                    break;
                case 9 :
                    // ShellCommand.g:1701:8: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
                    {
                    ...
                    break;
                case 10 :
                    // ShellCommand.g:1702:8: '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )?
                    {
                    matchRange('0','3'); if (state.failed) return ;
                    // ShellCommand.g:1702:17: ( '0' .. '7' ( '0' .. '7' )? )?
                    int alt15=2;
                    ...
                    switch (alt15) {
                        case 1 :
                            // ShellCommand.g:1702:18: '0' .. '7' ( '0' .. '7' )?
                            {
                            matchRange('0','7'); if (state.failed) return ;
                            // ShellCommand.g:1702:27: ( '0' .. '7' )?
                            int alt14=2;
                    ...
                    break;
                case 11 :
                    // ShellCommand.g:1702:45: '4' .. '7' ( '0' .. '7' )?
                    {
                    matchRange('4','7'); if (state.failed) return ;
                    // ShellCommand.g:1702:54: ( '0' .. '7' )?
                    int alt16=2;
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // ShellCommand.g:1708:10: ( ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' ) )
            // ShellCommand.g:1709:5: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )
            {
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1716:6: ( ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // ShellCommand.g:1717:5: ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // ShellCommand.g:1717:39: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mVOCAB() throws RecognitionException {
        try {
            // ShellCommand.g:1724:6: ( '\\U0003' .. '\\U0377' )
            // ShellCommand.g:1725:5: '\\U0003' .. '\\U0377'
            {
    ...
    public final void synpred1_ShellCommand_fragment() throws RecognitionException {   
        // ShellCommand.g:1669:7: ( INT '..' )
        // ShellCommand.g:1669:9: INT '..'
        {
        mINT(); if (state.failed) return ;
        match(".."); if (state.failed) return ;
    ...
    public final void synpred2_ShellCommand_fragment() throws RecognitionException {   
        // ShellCommand.g:1670:7: ( REAL )
        // ShellCommand.g:1670:9: REAL
        {
        mREAL(); if (state.failed) return ;
