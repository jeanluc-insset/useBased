...
@SuppressWarnings("all") public class OCLLexer extends Lexer {
    ...
    public final void mT__52() throws RecognitionException {
        try {
            int _type = T__52;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:42:7: ( 'allInstances' )
            // OCL.g:42:9: 'allInstances'
            {
    ...
    public final void mT__55() throws RecognitionException {
        try {
            int _type = T__55;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:45:7: ( 'oclAsType' )
            // OCL.g:45:9: 'oclAsType'
            {
    ...
    public final void mT__56() throws RecognitionException {
        try {
            int _type = T__56;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:46:7: ( 'oclIsKindOf' )
            // OCL.g:46:9: 'oclIsKindOf'
            {
    ...
    public final void mT__57() throws RecognitionException {
        try {
            int _type = T__57;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:47:7: ( 'oclIsTypeOf' )
            // OCL.g:47:9: 'oclIsTypeOf'
            {
    ...
    public final void mT__67() throws RecognitionException {
        try {
            int _type = T__67;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:57:7: ( 'OrderedSet' )
            // OCL.g:57:9: 'OrderedSet'
            {
    ...
    public final void mT__70() throws RecognitionException {
        try {
            int _type = T__70;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:60:7: ( 'Undefined' )
            // OCL.g:60:9: 'Undefined'
            {
    ...
    public final void mT__74() throws RecognitionException {
        try {
            int _type = T__74;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:64:7: ( 'Collection' )
            // OCL.g:64:9: 'Collection'
            {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:714:3: ( ( ' ' | '\\t' | '\\f' | NEWLINE ) )
            // OCL.g:715:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            {
            // OCL.g:715:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:731:11: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // OCL.g:732:5: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); if (state.failed) return ;

            // OCL.g:732:10: ( options {greedy=false; } : . )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mREAL() throws RecognitionException {
        try {
            // OCL.g:773:5: ( INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT ) )
            // OCL.g:774:5: INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            {
            mINT(); if (state.failed) return ;
            // OCL.g:774:9: ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // OCL.g:774:10: '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    {
                    match('.'); if (state.failed) return ;
                    mINT(); if (state.failed) return ;
                    // OCL.g:774:18: ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    int alt8=2;
    ...
    public final void mRANGE_OR_INT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:777:13: ( ( INT '..' )=> INT | ( REAL )=> REAL | INT )
            int alt11=3;
    ...
    public final void mESC() throws RecognitionException {
        try {
            // OCL.g:800:1: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? ) )
            // OCL.g:801:5: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            {
            match('\\'); if (state.failed) return ;
            // OCL.g:802:6: ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            int alt17=11;
            switch ( input.LA(1) ) {
            case 'n':
                {
            ...
            switch (alt17) {
                ...
                case 8 :
                    ...
                    break;
                case 9 :
                    // OCL.g:810:8: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
                    {
                    ...
                    break;
                case 10 :
                    // OCL.g:811:8: '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )?
                    {
                    matchRange('0','3'); if (state.failed) return ;
                    // OCL.g:811:17: ( '0' .. '7' ( '0' .. '7' )? )?
                    int alt15=2;
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // OCL.g:817:10: ( ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' ) )
            // OCL.g:818:5: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )
            {
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // OCL.g:825:6: ( ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // OCL.g:826:5: ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
    ...
    public final void mVOCAB() throws RecognitionException {
        try {
            // OCL.g:833:6: ( '\\U0003' .. '\\U0377' )
            // OCL.g:834:5: '\\U0003' .. '\\U0377'
            {
    ...
    static final String DFA19_eotS =
        "\1\uffff\22\53\1\uffff\1\110\1\112\2\uffff\1\115\1\uffff\1\117\1"+
        "\uffff\1\121\3\uffff\1\124\13\uffff\1\53\1\126\2\53\1\131\1\132"+
        "\24\53\17\uffff\1\160\1\uffff\2\53\2\uffff\1\53\1\167\1\170\1\53"+
        "\1\172\1\173\1\53\1\175\5\53\1\u0083\1\53\1\u0085\5\53\1\uffff\6"+
        "\53\2\uffff\1\53\2\uffff\1\u0092\1\uffff\1\u0093\1\u0094\1\u0095"+
        "\2\53\1\uffff\1\53\1\uffff\3\53\1\u009c\10\53\4\uffff\1\u00a6\1"+
        "\u00a7\3\53\1\u00ab\1\uffff\11\53\2\uffff\3\53\1\uffff\1\53\1\u00b9"+
        "\1\u00ba\12\53\2\uffff\3\53\1\u00c8\2\53\1\u00cb\3\53\1\u00cf\2"+
        "\53\1\uffff\2\53\1\uffff\1\53\1\u00d5\1\53\1\uffff\4\53\1\u00db"+
        "\1\uffff\1\u00dc\1\u00dd\1\u00de\2\53\4\uffff\1\u00e1\1\u00e2\2"+
        "\uffff";
    ...
    static final String DFA19_maxS =
        ...
        "\1\75\1\uffff\1\56\1\uffff\1\75\3\uffff\1\76\13\uffff\1\164\1\172"+
    ...
    static final String DFA19_acceptS =
        ...
        "\1\77\1\100\1\101\32\uffff\1\41\1\42\1\74\1\43\1\65\1\47\1\50\1"+
        "\46\1\53\1\52\1\56\1\55\1\63\1\66\1\62\1\uffff\1\2\2\uffff\1\17"+
    ...
    static final String[] DFA19_transitionS = {
            "\2\23\1\uffff\2\23\22\uffff\1\23\1\uffff\1\52\1\35\1\53\2\uffff"+
            "\1\51\1\41\1\45\1\47\1\42\1\31\1\25\1\32\1\24\12\50\1\30\1\46"+
            "\1\40\1\33\1\34\1\uffff\1\26\1\53\1\15\1\22\1\21\12\53\1\16"+
            "\3\53\1\14\1\20\1\17\5\53\1\37\1\uffff\1\44\1\uffff\1\53\1\uffff"+
            "\1\5\2\53\1\6\1\12\1\13\2\53\1\2\2\53\1\1\1\53\1\7\1\3\1\10"+
            "\3\53\1\11\3\53\1\4\2\53\1\36\1\27\1\43",
            "\1\54",
            "\1\60\6\uffff\1\56\1\55\5\uffff\1\57",
            "\1\62\16\uffff\1\61",
            "\1\63",
            "\1\65\1\uffff\1\64",
            "\1\66",
