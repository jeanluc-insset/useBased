...
/**
 * Navigation expression from one class to another.<br/>
 * TODO: suppression de "final" sur la classe par JLD le 28/01/2012
 * De cette fa&ccedil;on, le visiteur peut remplacer les expressions de
 * navigation par un d&eacute;corateur.
 *
 * @version     $ProjectVersion: 0.393 $
 * @author  Mark Richters
 */
public class ExpNavigation extends Expression {
