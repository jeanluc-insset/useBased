...
// $Id: Bag.java 2626 2011-10-19 09:19:51Z lhamann $
...
public interface Bag<T> extends Collection<T> {
     ...
     * TODO : renommage en bagContains au lieu de contains par JLD le
     * 25/01/2012
     *
     * @exception NullPointerException obj is null.
     */
    boolean bagContains(T obj);
     ...
     * TODO : renommage en bagRemove par JLD le 25/01/2012
     *
     * @return true if the Bag contained the specified element.
     */
    boolean bagRemove(T o);
